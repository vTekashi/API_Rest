...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handlerAllExceptions(Exception ex, WebRequest request){
		...
		ErrorResponse error = new ErrorResponse(httpStatus.value(), "Erro ao processar a requsição", detalhes);
	...
	public final ResponseEntity<Object> handleNoSuchElementFoundException(NoSuchElementFoundException ex, WebRequest request){
		...
		ErrorResponse error = new ErrorResponse(httpStatus.value(), "O Registro não foi encontrado", detalhes);
